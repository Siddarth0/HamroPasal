export const otpEmailTemplate = (otp: string, ttlMinutes: number): string => `
  <div style="font-family: Arial, sans-serif; max-width: 480px; margin: 0 auto; padding: 24px; color: #1a1a1a;">
    ...
    <p style="margin: 0; font-size: 13px; color: #999;">
      This code expires in ${ttlMinutes} minutes. If you didn't create an account, you can ignore this email.
    </p>
  </div>
`;
