...
export function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-20 right-4 z-50 flex h-[520px] max-h-[calc(100vh-7rem)] w-[360px] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl md:bottom-4 md:max-h-[calc(100vh-3rem)]">
